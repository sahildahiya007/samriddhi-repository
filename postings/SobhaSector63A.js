const SobhaSector63A = {
  ...
  details:
    "New Ultra-Luxury Residential Project by Sobha Limited in Sector 63A, Gurugram. Known for unmatched construction quality and timely delivery, this new launch delivers premium living for homebuyers who value space, privacy, and excellence.",
  highlights: [
  ...
  detailsSections: [
    {
      ...
      text:
        "New Ultra-Luxury Residential Project by Sobha Limited in Sector 63A, Gurugram. Sobha Limited proudly presents a new ultra-luxury residential project designed for those who value space, privacy, and excellence. This upcoming launch is set to become one of the most sought-after luxury addresses in Gurugram.",
    },
    {
      heading: "Prime Location",
      text:
        "Located on Golf Course Extension Road, Sector 63A, this project offers seamless connectivity to Golf Course Road, NH-48, Sohna Road, premium schools, hospitals, and business districts. It is surrounded by high-end developments and strong social infrastructure.",
    },
    {
      heading: "Project Overview",
      text:
        "This 12-acre low-density residential development is thoughtfully planned with only around 600 exclusive units, ensuring privacy and expansive open spaces. The project features premium towers, grand entry, superior ventilation, and views toward the Aravalli hills.",
    },
    {
  ...
  unitConfigs: [
    { type: "3 BHK", size: "2,350 – 2,760 sq.ft" },
    { type: "4 BHK", size: "3,120 – 3,820 sq.ft" },
  ],
