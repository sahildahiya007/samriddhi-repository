...
const testimonials = [
  {
    quote:
      "Samridhi Properties built our dream villa in Gurgaon with exceptional quality and professionalism.",
    name: "Rajesh K.",
    rating: 5,
  },
  {
...
export default function Construction({
  ...
  const handleRateUpdate = async () => {
    setRateMsg("");
    try {
      const token = window.prompt("Enter admin JWT token:");
  ...
  return (
    <section id="construction" className="min-h-screen">
      ...
      <section
        ...
        className="relative min-h-[92vh] flex items-center justify-center overflow-hidden reveal"
        style={{
      ...
      >
        <div className="max-w-6xl px-6 text-center relative z-10">
          ...
          <h2
            className="text-xl md:text-2xl font-medium mb-10 leading-relaxed"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-10 py-4 rounded-full font-bold text-lg bg-orange-500 text-white shadow-lg shadow-orange-300/50 hover:bg-orange-600 transition-all"
            >
            ...
            <a
              ...
              className="px-10 py-4 rounded-full font-bold text-lg border-2 border-white text-white hover:bg-white hover:text-black transition-all"
            >
              Our recent projects
            </a>
          </div>
      ...
      <section
        ...
        className="py-24 px-6 max-w-7xl mx-auto reveal"
      ...
      >
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Samridhi Properties delivers construction with one-point
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-6">
          {services.map((service, i) => (
            <div
              key={i}
              className="group p-8 rounded-3xl hover:-translate-y-4 transition-all duration-500 hover:shadow-2xl border border-gray-100 hover:border-accent/30 bg-white"
      ...
      {constructionListings.length > 0 && (
        <section className="py-24 px-6" style={{ backgroundColor: "#fff7f2" }}>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-5 gap-5">
            {[
              ...
              <div
                key={i}
                className="rounded-3xl p-8 bg-white border border-gray-200 shadow-sm text-center"
              >
                <div
      ...
      <section className="py-24 px-6 relative">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          >
            Why Choose Samridhi Properties
          </h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="p-8 rounded-2xl hover:bg-accent/5 transition-all group"
            >
              <item.icon className="w-16 h-16 text-accent mb-6 group-hover:scale-110 transition-transform mx-auto" />
              <h3
          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-start">
            ...
            <div className="space-y-5">
              {budget ? (
                ...
                <div className="rounded-3xl bg-white border border-orange-200 p-8 text-center">
      ...
      <section className="py-24 px-6 bg-cream">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="p-10 rounded-3xl bg-white shadow-xl hover:shadow-2xl transition-all border border-gray-100"
            >
      ...
      >
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <a
            href="#contact-construction"
            className="inline-block px-12 py-6 rounded-2xl font-bold text-2xl bg-accent text-white shadow-2xl hover:scale-105 transition-all"
          >
      ...
      >
        ...
        <form
          onSubmit={submitForm}
          className="grid gap-6 p-8 md:p-10 rounded-3xl bg-white shadow-2xl border border-gray-100"
          style={{ boxShadow: "0 30px 60px rgba(0,0,0,0.1)" }}
        >
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label className="block font-bold text-lg mb-3">Full Name</label>
              <input
                name="name"
                value={inquiryForm?.name || ""}
                onChange={onInquiryChange}
                required
                className="w-full p-4 border-2 border-gray-200 rounded-2xl focus:border-orange-400 focus:outline-none text-lg"
